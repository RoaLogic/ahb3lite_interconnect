...
Figure 3‑2 shows an example bus structure where a Bus Master -- Master-1
...
\missingfigure{HREADYOUT and HREADY Routing}
...
\missingfigure{Single Master/Slave Routing}
